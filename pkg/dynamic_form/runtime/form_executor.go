...
import (
	...
	"github.com/ArtisanCloud/CoreX/pkg/dynamic_form/model"
)
...
// ValidateAndFill 验证并填充表单输入（简化实现，表达式/条件引擎需扩展）
func ValidateAndFill(schema *model.FormSchema, input map[string]interface{}) (*Result, error) {
	res := &Result{
